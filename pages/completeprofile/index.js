...
const validationSchema = Yup.object({
  firstName: Yup.string()
    ...
    .max(12, "Firts name length is not valid"),

  lastName: Yup.string()
    .required("Last name is reqiured")
    .max(12, "Last name length is not valid"),
...
const AccountCreated = () => {
  ...
  const onSubmit = (values, submitProps) => {
    ...
    axios
      .post("https://vp.megaverse.today/api/v1/auth/compliteProfile", values, {
      ...
      .then((res) => {
        ...
        res.data.success ? router.push("/profilecompleted") : null;
      })
      .catch((error) => {
        console.log(error);
      });
              ...
              <Grid container>
                ...
                >
                  <h1
                    ...
                    className="com-profile-headings"
                  >
                  ...
                  <Form>
                    ...
                    <div>
                      <label className="signup-form__label">Country:</label>
                      <select
                        className={
                        ...
                        {({ field, form }) => {
                          ...
                          const ExampleCustomInput = forwardRef(
                            ({ value, onClick }, ref) => (
                              ...
                              >
                                {value ? (
                                  <span className="select-date-span-val">
                                    {value}
                                  </span>
                                ) : (
                                  <span className="select-date-span-text">
                                    Select a Date
                                  </span>
                                )}
                              </button>
